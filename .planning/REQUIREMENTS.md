...
- [x] **BUG-01**: Fix stop/start crash — resolve camera lifecycle and orphaned MJPEG generator issues
- [x] **BUG-02**: Fix thread safety issues in stream processing pipeline
